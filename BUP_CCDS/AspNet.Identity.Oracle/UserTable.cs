...
namespace AspNet.Identity.Oracle
{
        ...
        where TUser :IdentityUser
    {
        ...
        {
            const string commandText = @"SELECT NAME FROM ASPNETUSERS WHERE ID = :USERID";
        ...
        {
            const string commandText = @"SELECT ID FROM ASPNETUSERS WHERE USERNAME = :NAME";
            var parameters = new List<OracleParameter>
            {
        ...
        {
            TUser user;
            const string commandText = @"SELECT * FROM ASPNETUSERS WHERE ID = :USERID";
            var parameters = new List<OracleParameter>
            {
                new OracleParameter{ ParameterName = "USERID", Value = userId, OracleDbType = OracleDbType.Varchar2 }
            };
        ...
        public List<TUser> GetUserByName(string userName)
        {
            ...
            const string commandText = @"SELECT * FROM ASPNETUSERS WHERE USERNAME = :NAME";
            var parameters = new List<OracleParameter>
            {
                new OracleParameter{ ParameterName = "NAME", Value = userName, OracleDbType = OracleDbType.Varchar2}
            };
        ...
        {
            var users = new List<TUser>();
            const string commandText = @"SELECT * FROM ASPNETUSERS WHERE EMAIL = :EMAIL";
            var parameters = new List<OracleParameter>
            {
        ...
        {
            const string commandText = @"SELECT PASSWORDHASH FROM ASPNETUSERS WHERE ID = :USERID";
            var parameters = new List<OracleParameter>
            {
                new OracleParameter{ ParameterName = "USERID", Value = userId, OracleDbType = OracleDbType.Varchar2 }
            };
        ...
        {
            const string commandText = @"UPDATE ASPNETUSERS SET PASSWORDHASH = :PWHASH WHERE ID = :USERID";
            var parameters = new List<OracleParameter>
            {
        ...
        {
            const string commandText = @"SELECT SECURITYSTAMP FROM ASPNETUSERS WHERE ID = :USERID";
            var parameters = new List<OracleParameter>
            {
                new OracleParameter{ ParameterName = "USERID", Value =  userId, OracleDbType = OracleDbType.Varchar2 }
            };
        ...
        public int Insert(TUser user)
        {
            ...
            var parameters = new List<OracleParameter>
            {
                ...
                new OracleParameter{ ParameterName = "LOCKOUTENABLED", Value = user.LockoutEnabled, OracleDbType = OracleDbType.Decimal },
