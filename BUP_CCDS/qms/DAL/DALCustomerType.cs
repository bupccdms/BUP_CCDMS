...
namespace qms.DAL
{
    public class DALCustomerType
    {
        ...
        private void MapParameters(tblCustomerType CustomerType)
        {
            ...
            manager.AddParameter(new OracleParameter("p_token_prefix", CustomerType.token_prefix));
            manager.AddParameter(new OracleParameter("p_is_default", CustomerType.is_default));
        }
