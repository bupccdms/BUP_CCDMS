...
namespace qms.DAL
{
    public class DALDepartmentUsers
    {
        ...
        private void MapParameters(tblDepartmentUser departmentuser)
        {
            manager.AddParameter(new OracleParameter("p_department_id", departmentuser.department_id));
