...
namespace qms.Models
{
    ...
    public partial class qmsEntities : DbContext
    {
        ...
        public virtual DbSet<tblDepartmentUser> tblDepartmentUsers { get; set; }
        ...
        public virtual ObjectResult<Nullable<int>> psp_getNewToken(Nullable<int> department_id)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Nullable<int>>("psp_getNewToken", department_idParameter);
        }
    
        public virtual ObjectResult<GetInProgressTokenList_Result> GetInProgressTokenList(Nullable<int> department_id)
        {
            var department_idParameter = department_id.HasValue ?
                new ObjectParameter("department_id", department_id) :
                new ObjectParameter("department_id", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<GetInProgressTokenList_Result>("GetInProgressTokenList", department_idParameter);
        }
    }
}
